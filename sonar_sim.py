...
class SonarConfig:
    ...
    Defaults are sized for a 120 kHz FLS targeting ~300 m, in the spirit
    of imaging / obstacle-avoidance sonars at this frequency band (e.g.
    Kongsberg Mesotech 1071, Tritech SeaKing long-range). Higher-frequency
    systems trade range for resolution: Tritech Gemini 720i (720 kHz,
    ~120 m), Sound Metrics ARIS (~1.8 MHz, ~30 m).
    """
    # ---- Geometry ----
    ...
    # ---- Acoustic / signal ----
    freq_kHz:        float = 120.0    # 120 kHz: ~44 dB/km absorption
